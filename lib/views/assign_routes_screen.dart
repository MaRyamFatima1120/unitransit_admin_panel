        ...
        children: [
          Row(
            ...
            children: [
              Row(
                children: [
                  Icon(Icons.calendar_today_rounded, color: AppColors.primaryNavy, size: 20),
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: AppColors.primaryNavy)),
            ...
            builder: (context, snapshot) {
              ...
              if (!snapshot.hasData || snapshot.data!.isEmpty) {
                return const Center(child: Padding(
                  padding: EdgeInsets.all(32.0),
                  child: Text('No schedules found. Create schedules first.', style: TextStyle(color: Colors.grey)),
                ));
              }
                ...
                children: [
                  ...
                  schedules.isEmpty
                      ? const Center(child: Padding(
                          ...
                          child: Text('No schedules for this date.', style: TextStyle(color: Colors.grey)),
                        ))
                      : ListView.builder(
                          shrinkWrap: true,
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Row(
                children: [
                  Icon(Icons.directions_bus_rounded, size: 13, color: AppColors.primaryNavy),
                  ...
                  const SizedBox(width: 12),
                  Icon(Icons.access_time_filled_rounded, size: 13, color: AppColors.textSecondary),
                  const SizedBox(width: 4),
                  Text(
          ...
          Row(
            children: [
              Expanded(
                child: Row(
                  children: [
                    Icon(Icons.drive_eta_rounded, size: 13, color: AppColors.textSecondary),
                    const SizedBox(width: 4),
                    Expanded(
                      child: Text(
              ...
              Expanded(
                child: Row(
                  children: [
                    Icon(Icons.person_pin_rounded, size: 13, color: AppColors.textSecondary),
                    const SizedBox(width: 4),
                    Expanded(
                      child: Text(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.directions_bus_rounded, size: 14, color: AppColors.primaryNavy),
                    const SizedBox(width: 6),
                    Text(
                      schedule.busNumber ?? 'TBA',
                ...
                Row(
                  children: [
                    Icon(Icons.access_time_filled_rounded, size: 14, color: AppColors.textSecondary),
                    const SizedBox(width: 6),
                    Text(
                      schedule.departureTime ?? 'Live',
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.drive_eta_rounded, size: 14, color: AppColors.textSecondary),
                    const SizedBox(width: 6),
                    Expanded(
                      child: Text(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(schedule.route, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: AppColors.textDark), maxLines: 2, overflow: TextOverflow.ellipsis),
                  ),
                  const Divider(height: 24),
                  ListTile(
                    leading: Container(padding: EdgeInsets.all(8), decoration: BoxDecoration(color: AppColors.primaryNavy.withOpacity(0.08), shape: BoxShape.circle), child: Icon(Icons.edit_rounded, color: AppColors.primaryNavy, size: 20)),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.assignment_ind_rounded, size: 48, color: AppColors.primaryNavy),
            ),
            const SizedBox(height: 16),
            Text('No Schedule Selected', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: AppColors.textDark)),
            const SizedBox(height: 8),
            Text('Select a schedule from the left to assign driver, conductor, and crew details.', textAlign: TextAlign.center, style: TextStyle(fontSize: 13, color: AppColors.textSecondary)),
          ],
        ),
      ),
    );
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('ASSIGN DRIVER', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 10, color: AppColors.primaryNavy, letterSpacing: 1.5)),
          const SizedBox(height: 12),
                      ...
                      ...drivers.map((d) => DropdownMenuItem<String>(
                        ...
                        child: Row(children: [
                          CircleAvatar(
                            ...
                            child: d.profileUrl == null ? Text(d.name.isNotEmpty ? d.name[0] : 'D', style: TextStyle(fontSize: 11, color: AppColors.primaryNavy)) : null,
                          ),
                          const SizedBox(width: 10),
                          Expanded(child: Column(
                            ...
                            children: [
                              ...
                              Text(d.phoneNumber, style: TextStyle(fontSize: 10, color: AppColors.textSecondary)),
                            ],
                          )),
                        ]),
                      )),
          ...
          const SizedBox(height: 24),
          // Conductor
          Text('ASSIGN CONDUCTOR', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 10, color: AppColors.primaryNavy, letterSpacing: 1.5)),
          const SizedBox(height: 12),
          TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: Icon(Icons.person_pin_outlined, color: AppColors.primaryNavy),
          ...
          const SizedBox(height: 24),
          // Bus ID
          Text('ASSIGN BUS ID / NUMBER', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 10, color: AppColors.primaryNavy, letterSpacing: 1.5)),
          const SizedBox(height: 12),
          Builder(
            builder: (context) {
              ...
              return DropdownButtonFormField<String>(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.directions_bus_outlined, color: AppColors.primaryNavy),
                  border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
                  enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: AppColors.borderLight)),
                  focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: AppColors.primaryNavy)),
                  contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
          ...
          const SizedBox(height: 24),
          // Departure Time
          Text('ASSIGN DEPARTURE TIME', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 10, color: AppColors.primaryNavy, letterSpacing: 1.5)),
          const SizedBox(height: 12),
          GestureDetector(
            onTap: () async {
            ...
            child: AbsorbPointer(
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.access_time_rounded, color: AppColors.primaryNavy),
                  suffixIcon: Icon(Icons.schedule_rounded, color: AppColors.textSecondary, size: 18),
                  border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
                  enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: AppColors.borderLight)),
                  focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: AppColors.primaryNavy)),
                  contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('ASSIGNMENT SUMMARY', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 10, color: AppColors.primaryNavy, letterSpacing: 1.2)),
                const SizedBox(height: 12),
            ...
            children: [
              Expanded(
                child: OutlinedButton(
                  ...
                  child: Text('Reset', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textDark)),
                ),
              ),
              const SizedBox(width: 16),
              Expanded(
  ...
  Widget _summaryRow(IconData icon, String label, String value) {
    return Padding(
      ...
      child: Row(children: [
        ...
        Expanded(child: Text(value, style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: AppColors.textDark), overflow: TextOverflow.ellipsis)),
      ]),
    );
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        StreamBuilder<List<BusSchedule>>(
                          ...
                          builder: (context, snapshot) {
                            final allSchedules = snapshot.data ?? [];
                            // Master route templates: no specific date, no specific operating days
                            // and departureTime is null/empty/TBA/Live (true template not a scheduled instance)
                            final masterRoutes = allSchedules.where((s) {
                            ...
                            // Fallback: if no master routes found show all unique route names
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                DropdownButtonFormField<String>(
                                  ...
                                  decoration: InputDecoration(
                                    prefixIcon: Icon(Icons.map_rounded, color: AppColors.primaryNavy, size: 18),
                            ...
                            final busField = Builder(
                              builder: (context) {
                                ...
                                return Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('Bus ID / Number', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12, color: AppColors.primaryNavy)),
                                    const SizedBox(height: 6),
                                    DropdownButtonFormField<String>(
                                      value: busController.text.isNotEmpty ? busController.text : null,
                                      decoration: InputDecoration(
                                        hintText: 'Select Bus',
                                        prefixIcon: Icon(Icons.directions_bus_outlined, color: AppColors.textSecondary, size: 18),
                                        contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
                                        border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)),
                                        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide(color: AppColors.borderLight)),
                                      ),
                                  ...
                                  child: AbsorbPointer(
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
                                        prefixIcon: Icon(Icons.access_time_rounded, color: AppColors.primaryNavy, size: 18),
                                        suffixIcon: Icon(Icons.schedule_rounded, color: AppColors.textSecondary, size: 16),
                                        border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)),
                                        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide(color: AppColors.borderLight)),
                                      ),
                                      validator: (val) => val == null || val.trim().isEmpty ? 'Required' : null,
                                    ...
                                    ...drivers.map((d) => DropdownMenuItem<String>(
                                      ...
                                      child: Row(children: [
                                        CircleAvatar(
                                          ...
                                          backgroundColor: AppColors.primaryNavy.withOpacity(0.1),
                                          backgroundImage: d.profileUrl != null ? NetworkImage(d.profileUrl!) : null,
                                          child: d.profileUrl == null ? Text(d.name.isNotEmpty ? d.name[0] : 'D', style: TextStyle(fontSize: 10, color: AppColors.primaryNavy)) : null,
                                        ),
                                        const SizedBox(width: 8),
                                        Expanded(
                                          child: Text(
