                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Icon(Icons.colorize_rounded, size: 14, color: AppColors.textSecondary),
                        ),
                      ),
                    ],
                  ),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 32),
              Consumer2<GenderConfigViewModel, LoginViewModel>(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(widget.hexColor, style: TextStyle(color: AppColors.textSecondary, fontSize: 12)),
            ],
          ),
        ),
      ),
