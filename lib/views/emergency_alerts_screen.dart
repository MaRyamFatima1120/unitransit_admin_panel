...
class _EmergencyAlertsScreenState extends State<EmergencyAlertsScreen>
  ...
  Map<String, dynamic> _getAlertMetadata(String message) {
    ...
    if (msg.contains('accident') || msg.contains('collision') || msg.contains('hadsa')) {
      return {
    ...
    } else if (msg.contains('medical') || msg.contains('sick') || msg.contains('faint') || msg.contains('tibb') || msg.contains('pain') || msg.contains('hospital')) {
      return {
    ...
    } else if (msg.contains('harass') || msg.contains('threat') || msg.contains('fight') || msg.contains('security') || msg.contains('rob') || msg.contains('danger')) {
      return {
    ...
    } else if (msg.contains('breakdown') || msg.contains('engine') || msg.contains('puncture') || msg.contains('tire') || msg.contains('kharab') || msg.contains('fuel')) {
      return {
  ...
  void _showResolveDialog(BuildContext context, Map<String, dynamic> alert, DashboardViewModel viewModel) {
            ...
            return AlertDialog(
              ...
              title: Row(
                children: [
                  ...
                  const Text('Resolve Emergency SOS', style: TextStyle(fontWeight: FontWeight.bold)),
                ],
              ),
              content: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Action Taken', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          ...
                          items: actions.map((act) => DropdownMenuItem(
                            value: act,
                            child: Text(act, style: const TextStyle(fontSize: 13)),
                          )).toList(),
                          onChanged: (val) {
                            if (val != null) {
                              setDialogState(() {
                    ...
                    const Text('Additional Notes (Optional)', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                    const SizedBox(height: 8),
                    TextField(
                      controller: notesController,
                      maxLines: 3,
                      decoration: InputDecoration(
                        hintText: 'Enter any additional details about the incident response...',
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    final fullResolutionNotes = '$actionTaken. ${noteText.isNotEmpty ? "Notes: $noteText" : ""}';
                    ...
                    setState(() {
                      ...
                      alert['resolvedAt'] = DateTime.now().millisecondsSinceEpoch;
                    });
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> filteredAlerts = viewModel.emergencyAlerts.where((alert) {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _buildHeader(context, viewModel.activeEmergencyAlerts),
    ...
    return Row(
      children: [
        Container(
          ...
          child: Icon(Icons.warning_amber_rounded, color: AppColors.error, size: isMobile ? 20 : 28),
        ),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Monitor and respond to panic signals sent by drivers and students.',
                style: GoogleFonts.poppins(
  ...
  Widget _buildFilterTabs() {
    return Wrap(
      spacing: 8,
      runSpacing: 8,
      children: ['All', 'Active', 'Resolved'].map((tab) {
        final isSelected = _filter == tab;
        return InkWell(
          onTap: () {
            setState(() {
              _filter = tab;
              _selectedAlert = null; // Reset selection to trigger auto-select
            });
          },
          borderRadius: BorderRadius.circular(12),
  ...
  Widget _buildAlertsList(List<Map<String, dynamic>> alerts) {
    ...
    final lng = (alert['longitude'] as num).toDouble();
    final timeStr = alert['timestamp'] != null
        ? DateFormat('hh:mm:ss a • MMMM dd, yyyy').format(
            DateTime.fromMillisecondsSinceEpoch(alert['timestamp']))
        : 'Unknown';
            ...
            Container(
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    radius: 24,
                    backgroundImage: (_firestoreUserData?['profileImage'] != null && _firestoreUserData!['profileImage'].toString().isNotEmpty)
                        ? NetworkImage(_firestoreUserData!['profileImage'])
                        : (_firestoreUserData?['profileUrl'] != null && _firestoreUserData!['profileUrl'].toString().isNotEmpty)
                            ? NetworkImage(_firestoreUserData!['profileUrl'])
                            : null,
                    backgroundColor: isActive
                        ? categoryColor.withOpacity(0.1)
                        : Colors.green.withOpacity(0.1),
                    child: (_firestoreUserData?['profileImage'] == null && _firestoreUserData?['profileUrl'] == null)
                        ? Icon(
                            isActive ? categoryIcon : Icons.check_circle_outline_rounded,
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Text(
                              _firestoreUserData?['name'] ?? alert['userName'] ?? 'Anonymous',
                            ...
                            if (_firestoreUserData?['role'] != null) ...[
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: _firestoreUserData!['role'] == 'Driver'
                  ...
                  if (isActive)
                    ElevatedButton.icon(
                      onPressed: () => _showResolveDialog(context, alert, viewModel),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.green,
                        foregroundColor: Colors.white,
                      ...
                      label: const Text('Resolve Alert', style: TextStyle(fontWeight: FontWeight.bold)),
                    )
                  else
                    Container(
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                      color: isActive ? categoryColor : Colors.grey,
                                      width: 2,
                                    ),
                                  ),
                                  child: Icon(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildMapButton(
                          ...
                          onPressed: () => _animatedMapMove(LatLng(lat, lng), 15.0),
                        ),
                      ],
                    ),
                  ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          if (_firestoreUserData != null)
                            Text(
                              ...
                              style: TextStyle(
                                fontSize: 10,
                                fontWeight: FontWeight.bold,
                                color: _firestoreUserData?['isVerified'] == true ? Colors.green : Colors.amber,
                              ),
                            ),
                        ],
                      ),
                      ...
                      Row(
                        children: [
                          const Icon(Icons.emergency_outlined, color: AppColors.textSecondary, size: 18),
                          const SizedBox(width: 12),
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Text('Incident Category', style: TextStyle(color: AppColors.textSecondary, fontSize: 11)),
                                Text(
                                  alert['message']?.toString().contains('Breakdown') == true
                                      ? 'Bus Breakdown / Engine failure'
                                      : alert['message']?.toString().contains('Accident') == true
                                          ? 'Accident / Collision'
                                          : alert['message']?.toString().contains('Security') == true
                                              ? 'Security / Dispute'
                                              : alert['message']?.toString().contains('Medical') == true
                                                  ? 'Medical Emergency'
                                                  : 'General Panic SOS',
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                          ...
                          if (isActive)
                            Container(
                              ...
                              child: const Text(
                                'PRIORITY: HIGH',
                                style: TextStyle(color: AppColors.error, fontWeight: FontWeight.bold, fontSize: 10),
                              ),
                            ),
                        ],
                      ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Text('Message / Reason', style: TextStyle(color: AppColors.textSecondary, fontSize: 11)),
                                Text(
                      ...
                      if (_firestoreUserData != null) ...[
                          ...
                          children: [
                            Expanded(
                              child: _buildBadgeDetailItem(
                                ...
                                badgeColor: _firestoreUserData?['isVerified'] == true ? Colors.green : Colors.amber,
                                badgeText: _firestoreUserData?['isVerified'] == true ? 'VERIFIED' : 'UNVERIFIED',
                              ),
                            ),
                            const SizedBox(width: 8),
                            Expanded(
                              child: _buildBadgeDetailItem(
                                ...
                                badgeColor: _firestoreUserData?['isBlocked'] == true ? Colors.red : Colors.green,
                                badgeText: _firestoreUserData?['isBlocked'] == true ? 'BLOCKED' : 'ACTIVE',
                              ),
                            ),
                            const SizedBox(width: 8),
                            Expanded(
                              child: _buildBadgeDetailItem(
                                ...
                                badgeColor: (_firestoreUserData?['status'] == 'Online' || _firestoreUserData?['status'] == 'Active')
                                    ? Colors.green
                                    : Colors.grey,
                                badgeText: (_firestoreUserData?['status'] ?? 'Offline').toString().toUpperCase(),
                              ),
                            ),
                          ],
                        ),
                          ...
                          children: [
                            Expanded(
                              child: _buildDetailCardItem(
                                ...
                                label: 'Full Name',
                                value: _firestoreUserData?['name'] ?? alert['userName'] ?? 'Anonymous',
                              ),
                            ),
                            const SizedBox(width: 16),
                            Expanded(
                              child: _buildDetailCardItem(
                                ...
                                label: 'Phone Number',
                                value: _firestoreUserData?['phoneNumber'] ?? _firestoreUserData?['phone'] ?? alert['phone'] ?? 'N/A',
                              ),
                            ),
                          ],
                        ),
                          ...
                          children: [
                            ...
                            Expanded(
                              child: _buildDetailCardItem(
                                ...
                                label: 'Gender',
                                value: _firestoreUserData?['gender'] ?? _firestoreUserData?['genderPreference'] ?? 'N/A',
                              ),
                            ),
                          ],
                        ),
                        ...
                        if (_firestoreUserData?['role'] == 'Driver') ...[
                            ...
                            children: [
                              Expanded(
                                child: _buildDetailCardItem(
                                  ...
                                  value: _firestoreUserData?['assignedBus'] ?? 'N/A',
                                ),
                              ),
                              const SizedBox(width: 16),
                              Expanded(
                                child: _buildDetailCardItem(
                                  ...
                                  value: _firestoreUserData?['licenseNumber'] ?? 'N/A',
                                ),
                              ),
                            ],
                          ),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: _buildDetailCardItem(
                                  ...
                                  label: 'Experience',
                                  value: _firestoreUserData?['experience'] != null ? "${_firestoreUserData?['experience']}" : 'N/A',
                                ),
                              ),
                            ],
                          ),
                          if (_firestoreUserData?['cnicFrontUrl'] != null || 
                              ...
                              _firestoreUserData?['licenseImageUrl'] != null) ...[
                            const SizedBox(height: 20),
                            const Text(
                            ...
                            Row(
                              children: [
                                if (_firestoreUserData?['cnicFrontUrl'] != null && _firestoreUserData!['cnicFrontUrl'].toString().isNotEmpty)
                                  Expanded(
                                    child: _buildDocumentButton(
                                      label: 'View CNIC Front',
                                      imageUrl: _firestoreUserData!['cnicFrontUrl'],
                                    ),
                                  ),
                                if (_firestoreUserData?['cnicBackUrl'] != null && _firestoreUserData!['cnicBackUrl'].toString().isNotEmpty) ...[
                                  const SizedBox(width: 12),
                                  Expanded(
                                    child: _buildDocumentButton(
                                      label: 'View CNIC Back',
                                      imageUrl: _firestoreUserData!['cnicBackUrl'],
                                    ),
                                  ),
                                ],
                                if (_firestoreUserData?['licenseImageUrl'] != null && _firestoreUserData!['licenseImageUrl'].toString().isNotEmpty) ...[
                                  const SizedBox(width: 12),
                                  Expanded(
                                    child: _buildDocumentButton(
                                      label: 'View License Copy',
                                      imageUrl: _firestoreUserData!['licenseImageUrl'],
                                    ),
                                  ),
                                ],
                              ],
                            ...
                            children: [
                              Expanded(
                                child: _buildDetailCardItem(
                                  ...
                                  value: _firestoreUserData?['studentId'] ?? _firestoreUserData?['rollNo'] ?? 'N/A',
                                ),
                              ),
                              const SizedBox(width: 16),
                              Expanded(
                            ...
                            children: [
                              Expanded(
                                child: _buildDetailCardItem(
                                  ...
                                  label: 'Department',
                                  value: _firestoreUserData?['department'] ?? 'N/A',
                                ),
                              ),
                              const SizedBox(width: 16),
                              Expanded(
                                child: _buildDetailCardItem(
                                  ...
                                  label: 'Semester',
                                  value: _firestoreUserData?['semester'] ?? 'N/A',
                                ),
                              ),
                            ],
                          ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Text('Timestamp', style: TextStyle(color: AppColors.textSecondary, fontSize: 11)),
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Text('Coordinates', style: TextStyle(color: AppColors.textSecondary, fontSize: 11)),
                                SelectableText(
                                  '$lat, $lng',
                                  style: GoogleFonts.firaCode(fontSize: 12, fontWeight: FontWeight.w500),
                                ),
                              ],
                            ),
                          ),
                      ...
                      if (!isActive) ...[
                        ...
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Icon(Icons.assignment_turned_in_rounded, color: Colors.green, size: 18),
                            const SizedBox(width: 12),
                            Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  const Text('Action & Log Notes', style: TextStyle(color: AppColors.textSecondary, fontSize: 11)),
                                  Text(
                                    alert['resolutionNotes'] ?? 'Marked as resolved by Admin',
                                    style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 13, color: AppColors.textDark),
                                  ),
                                  const SizedBox(height: 4),
                                  Text(
                        ...
                        StreamBuilder<QuerySnapshot>(
                          ...
                          builder: (context, reviewSnapshot) {
                            ...
                            final reviewDoc = reviewSnapshot.data!.docs.first.data() as Map<String, dynamic>;
                            final rating = reviewDoc['rating'] as int? ?? 5;
                            final comment = reviewDoc['review'] as String? ?? 'No comment provided';
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            const SizedBox(height: 8),
                                            const Text('User Review:', style: TextStyle(color: AppColors.textSecondary, fontSize: 11)),
                                            const SizedBox(height: 4),
                                            Text(
                                              '"$comment"',
                                              style: const TextStyle(
                        ...
                        children: [
                          Expanded(
                            child: _buildDirectoryContact(
                              ...
                              onTap: () {
                                Clipboard.setData(const ClipboardData(text: '051-111-222-333'));
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(content: Text('Campus Security contact copied.')),
                                );
                              },
                            ),
                          ),
                          ...
                          Expanded(
                            child: _buildDirectoryContact(
                              ...
                              onTap: () {
                                Clipboard.setData(const ClipboardData(text: '1122'));
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(content: Text('Rescue 1122 contact copied.')),
                                );
                              },
                            ),
                          ),
                          ...
                          Expanded(
                            child: _buildDirectoryContact(
                              ...
                              onTap: () {
                                Clipboard.setData(const ClipboardData(text: '15'));
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(content: Text('Police 15 contact copied.')),
                                );
                              },
                            ),
                          ),
  ...
  Widget _buildDocumentButton({required String label, required String imageUrl}) {
              ...
              child: Image.network(
                ...
                errorBuilder: (context, error, stackTrace) => const Center(
                  child: Padding(
                    ...
                    child: Text('Failed to load image. Invalid or expired URL.'),
                  ),
                ),
              ),
            ),
