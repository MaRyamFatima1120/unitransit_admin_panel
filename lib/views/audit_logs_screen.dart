      ...
      child: AnimatedContainer(
        ...
        child: Row(
          children: [
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    ...
                    child: Text(widget.log.adminName[0].toUpperCase(), style: const TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: AppColors.primaryNavy)),
                  ),
                  const SizedBox(width: 8),
                  Text(widget.log.adminName, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: AppColors.textDark)),
                ],
              )
            ),
            Expanded(
            ...
            Expanded(flex: 3, child: Text(widget.log.target, style: const TextStyle(fontSize: 13, color: AppColors.textDark))),
          ],
        ),
      ),
    );
