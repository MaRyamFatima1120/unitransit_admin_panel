...
class _SupportScreenState extends State<SupportScreen> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: viewModel.isLoading && viewModel.tickets.isEmpty
  ...
  Widget _buildStatsSummary(BuildContext context) {
    ...
    return Wrap(
      ...
      runSpacing: 12,
      children: [
        _buildQuickStat('New', newCount, Icons.assignment_late_rounded, AppColors.accentAmber),
        _buildQuickStat('In Progress', progressCount, Icons.assignment_ind_rounded, AppColors.primaryNavy),
        _buildQuickStat('Resolved', resolvedCount, Icons.assignment_turned_in_rounded, AppColors.primaryTeal),
      ],
    );
  }
                                ...
                                Row(
                                  children: [
                                    ...
                                    if (!ticket.adminRead) ...[
                                      const SizedBox(width: 8),
                                      IconButton(
                                        icon: const Icon(Icons.mark_chat_read_rounded, color: AppColors.primaryTeal, size: 22),
  ...
  Widget _buildRoleBadge(String role) {
    ...
    final Color bgColor = isDriver ? AppColors.primaryNavy.withOpacity(0.08) : AppColors.accentAmber.withOpacity(0.12);
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              const SizedBox(width: 6),
              Icon(Icons.copy_rounded, size: 10, color: AppColors.textSecondary.withOpacity(0.7)),
            ],
          ),
        ),
      ),
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.rate_review_rounded, color: AppColors.primaryTeal, size: 22),
                      ),
                      const SizedBox(width: 12),
                      const Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.done_all_rounded, color: AppColors.primaryTeal, size: 20),
            ),
            const SizedBox(width: 12),
            const Text(
        ...
        content: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(Icons.check_circle_outline_rounded, size: 16, color: AppColors.primaryTeal),
                const SizedBox(width: 8),
                const Text(
