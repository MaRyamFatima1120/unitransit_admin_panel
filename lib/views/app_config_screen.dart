  ...
  Widget _buildHeader(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text('Manage app versions and system-wide maintenance modes.',
  ...
  Widget _buildSection(String title, List<Widget> children) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(title, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: AppColors.primaryNavy)),
          const SizedBox(height: 24),
          ...children,
        ],
      ),
